...
public class BlockBasicTitania extends Block implements IDetectableResource, IPlantableBlock, ITerraformableBlock, ISortableBlock {
	public static final PropertyEnum<EnumBlockBasic> BASIC_TYPE = PropertyEnum.create("basictypetitania", EnumBlockBasic.class);

	public enum EnumBlockBasic implements IStringSerializable {
		SURFACE(0, "titania_surface"), SUB_SURFACE(1, "titania_sub_surface"), STONE(2, "titania_stone"), ORE_IRON(3, "titania_ore_iron"), ORE_TIN(4, "titania_ore_tin"), ORE_COPPER(5, "titania_ore_copper");
