...
public class BlockBasicIo extends Block implements IDetectableResource, IPlantableBlock, ITerraformableBlock, ISortableBlock {
	public static final PropertyEnum<EnumBlockBasic> BASIC_TYPE = PropertyEnum.create("basictypeio", EnumBlockBasic.class);

	public enum EnumBlockBasic implements IStringSerializable {
		SURFACE(0, "io_surface"), SUB_SURFACE(1, "io_sub_surface"), STONE(2, "io_stone"), ORE_IRON(3, "io_ore_iron"), ORE_TIN(4, "io_ore_tin"), ORE_COPPER(5, "io_ore_copper");
